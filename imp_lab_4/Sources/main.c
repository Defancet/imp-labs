...
void ADC0_Init(void)
{
	...
	// xxxx xx01 (Bus clock)/2
	// x11x xxxx Clock Divide (input clock)/8

	// 0b0000 0000 0000 0000 0000 0000 0110 0001
	ADC0_CFG1 = 0x00000061;

	// xxxx xx11 32 samples averaged
	// xxxx x1xx Hardware average function enabled
	// xxxx 1xxx Continuous Conversion Enable

	// 0b0000 0000 0000 0000 0000 0000 0000 1111
	ADC0_SC3 = 0x0000000F;

	// xxx0 0110 AD6 is selected as input.
	// xxxx x1xx Conversion complete interrupt is enabled.
	// xxxx 0xxx Conversion is not completed.

	// 0b0000 0000 0000 0000 0000 0000 0100 0110
	ADC0_SC1A = 0x00000046;
}
...
void ADC0_IRQHandler(void) {
	int res = 330 * ADC0_RA / 255;
    result[0] = res / 100 + '0';
	result[1] = '.' + '0';
    result[2] = res / 10 % 10 + '0';
	result[3] = res % 10 + '0';
}
/******************************************************************************/
